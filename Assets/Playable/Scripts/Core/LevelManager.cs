...
//             {
//                 if (spawnKeyIndex < _botCount)
//                     TrySpawnBot(spawnKeyIndex);
...
//                 _baseCharacterPrefab,
//                 new Vector3(config.SpawnPosX, 0f, config.SpawnPosZ),
//                 Quaternion.identity
//             );
...
//             // Toggle placement mode with M
//             if (e.type == EventType.KeyDown && e.keyCode == KeyCode.M)
//             {
//                 _placementMode = !_placementMode;

//                 Debug.Log(_placementMode
//                     ? "Enemy Placement Mode ENABLED"
//                     : "Enemy Placement Mode DISABLED");
...
//                         so.FindProperty("_botSpawnPositions");

//                     int newIndex = positionsProp.arraySize;

//                     positionsProp.InsertArrayElementAtIndex(newIndex);

//                     SerializedProperty element =
//                         positionsProp.GetArrayElementAtIndex(newIndex);
...
//                     Debug.Log($"Added Bot Spawn Position {newIndex + 1}: {hit.point}");
